...
| Integrante | Rol | Iniciales oficiales | Uso en ramas |
|---|---|---|---|
| Carlos Andrés Villamil Yusunguaira | Backend | CAVY | `feature/HU-XX-CAVY-short-description` |
| Juan Sebastián Murcia | QA | JSMV | `feature/HU-XX-JSMV-short-description` |
| Felipe Ardila | Frontend | AFAF | `feature/HU-XX-AFAF-short-description` |
| Kevin Santiago Cuesta | Product Owner | KSCH | `feature/HU-XX-KSCH-short-description` |

---

## Índice

| ADR | Decisión | Responsable principal | Iniciales | Estado |
|---|---|---|---|---|
| ADR-001 | Arquitectura basada en microservicios | Carlos Andrés Villamil Yusunguaira | CAVY | Aceptado |
| ADR-002 | Uso de API Gateway como punto único de entrada | Carlos Andrés Villamil Yusunguaira | CAVY | Aceptado |
| ADR-003 | Uso de base de datos por microservicio | Carlos Andrés Villamil Yusunguaira | CAVY | Aceptado |
| ADR-004 | Autenticación y autorización mediante JWT | Carlos Andrés Villamil Yusunguaira | CAVY | Aceptado |
| ADR-005 | Integración de facturación con proveedor tecnológico autorizado por DIAN | Kevin Santiago Cuesta | KSCH | Aceptado |
| ADR-006 | Dockerización de microservicios | Carlos Andrés Villamil Yusunguaira | CAVY | Aceptado |
| ADR-007 | Uso de Git Flow y ramas por historia de usuario | Juan Sebastián Murcia | JSMV | Aceptado |
| ADR-008 | Comunicación entre frontend y backend mediante servicios por feature | Felipe Ardila | AFAF | Aceptado |
| ADR-009 | Manejo centralizado de errores en backend | Juan Sebastián Murcia | JSMV | Aceptado |
| ADR-010 | Separación progresiva de ventas, pagos, caja y facturación | Kevin Santiago Cuesta | KSCH | Aceptado |
...
| Campo | Detalle |
|---|---|
| Responsable principal | Carlos Andrés Villamil Yusunguaira |
| Rol | Backend |
| Iniciales | CAVY |
| Apoyo | JSMV para validación QA; KSCH para validación funcional. |
| Rama sugerida | `feature/HU-053-CAVY-microservices-architecture` |
...
| Rol | Backend |
| Iniciales | CAVY |
| Apoyo | JSMV para pruebas de rutas; AFAF para validación de consumo desde frontend. |
| Rama sugerida | `feature/HU-053-CAVY-api-gateway` |
...
| Rol | Backend |
| Iniciales | CAVY |
| Apoyo | JSMV para pruebas de consistencia; KSCH para reglas funcionales por módulo. |
| Rama sugerida | `feature/HU-030-CAVY-database-per-service` |
...
| Rol | Backend |
| Iniciales | CAVY |
| Apoyo | AFAF para integración visual de login; JSMV para pruebas de autenticación. |
| Rama sugerida | `feature/HU-019-CAVY-jwt-authentication` |
...
| Campo | Detalle |
|---|---|
| Responsable principal | Kevin Santiago Cuesta |
| Rol | Product Owner |
| Iniciales | KSCH |
| Apoyo | CAVY para integración backend; AFAF para pantalla de configuración; JSMV para validación QA. |
| Rama sugerida | `feature/HU-025-KSCH-dian-provider-definition` |
...
| Rol | Backend |
| Iniciales | CAVY |
| Apoyo | JSMV para verificación de ambiente; AFAF para validación de frontend en Docker. |
| Rama sugerida | `feature/HU-053-CAVY-dockerize-services` |
...
| Campo | Detalle |
|---|---|
| Responsable principal | Juan Sebastián Murcia |
| Rol | QA |
| Iniciales | JSMV |
| Apoyo | KSCH para control de historias de usuario; CAVY y AFAF para aplicación en sus ramas. |
| Rama sugerida | `feature/HU-000-JSMV-git-flow-standards` |
...
| Campo | Detalle |
|---|---|
| Responsable principal | Felipe Ardila |
| Rol | Frontend |
| Iniciales | AFAF |
| Apoyo | CAVY para contratos de API; JSMV para pruebas de integración. |
| Rama sugerida | `feature/HU-014-AFAF-feature-services-communication` |
...
| Rol | QA |
| Iniciales | JSMV |
| Apoyo | CAVY para implementación backend; AFAF para visualización de errores en frontend. |
| Rama sugerida | `feature/HU-030-JSMV-error-handling-validation` |
...
| Rol | Product Owner |
| Iniciales | KSCH |
| Apoyo | CAVY para separación backend; AFAF para ajuste del flujo POS; JSMV para pruebas integrales. |
| Rama sugerida | `feature/HU-030-KSCH-pos-responsibility-split` |
